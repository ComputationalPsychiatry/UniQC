function [folderName, folderPath] = ...
    find_processing_folder(MrSeriesFolder, processingStep)
% Finds the folder given a processing step in an MrSeries_folder
%
% [folder_name, folder_path] = ...
% find_processing_folder(MrSeries_folder, processing_step)
%
% IN
...
%
% EXAMPLE
% find_processing_folder('mypath\MrSeries_1', 'realign')
