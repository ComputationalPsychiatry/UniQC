function affineTransformationMatrix = get_affine_transformation_matrix(this)
...
%
%   Y = MrImageGeometry()
%   Y.get_affine_transformation_matrix(inputs)
%
...
%
% EXAMPLE
%   get_affine_transformation_matrix
%
...
P(1:3) = geometryNifti.offcenterMillimeters;
P(4:6) = geometryNifti.rotationDegrees*pi/180;
P(7:9) = geometryNifti.resolutionMillimeters;
P(10:12) = geometryNifti.shearMillimeters;
