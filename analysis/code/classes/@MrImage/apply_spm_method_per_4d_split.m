function outputImage = apply_spm_method_per_4d_split(this, methodHandle, varargin)
...
%
%   Y = MrImage()
%   outputImage = Y.apply_spm_method_per_4d_split(this, methodHandle, 'paramName', paramValue, ...)
%
