...
% OUT
%   coeff_var         MrImage holding voxel-wise coefficient of variation
%                     image (coeff_var), i.e. 1./snr 
%                     (with thresholding to avoid Inf-values)
%
% EXAMPLE
%   Y = MrImage()
%   coeff_var = Y.compute_coeff_var('selectedVolumes', [6:100])
%
...
coeff_var = this.compute_stat_image('coeff_var', varargin{:});
