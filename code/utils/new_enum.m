function new_enum(varargin)
% new_enum creates a new enumeration file including header using a template.
%   new_enum(funname) opens the editor and pastes the content
...
% Modified: 2014-04-15 (Saskia Klein and Lars Kasper, IBT Zurich)	
    ...
    switch nargin
		case 0
			edit
			warning('new_enum without argument is the same as edit')
			return;
		case 1
			fname=varargin{:};
