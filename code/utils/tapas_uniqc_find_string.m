function indexFoundPattern = tapas_uniqc_find_string(stringArray, searchPattern, isExact)
...
%
%   indexFoundPattern = tapas_uniqc_find_string(stringArray, searchPattern, isExact)
%
% IN
