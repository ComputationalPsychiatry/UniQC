function tapas_uniqc_new_function(varargin)
% tapas_uniqc_new_function creates a new function including header using a template.
% tapas_uniqc_new_function(funname) opens the editor and pastes the content
% of a user-defined template into the file funname.m.
% 
%   Example
%       tapas_uniqc_new_function myfunfun
%           OR 
%       tapas_uniqc_new_function myfunfun author
%
...
% Modified: 2014-04-15 (Saskia Klein and Lars Kasper, IBT Zurich)	
	...
	switch nargin
		case 0
			edit
			warning('tapas_uniqc_new_function without argument is the same as edit')
			return;
		case 1
			fname=varargin{:};
